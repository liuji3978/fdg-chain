...
var (
	...
	app = flags.NewApp(gitCommit, gitDate, "the go-fdg command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2013-2020 The go-fdg Authors"
...
// miner.
func startNode(ctx *cli.Context, stack *node.Node, backend fdgapi.Backend) {
