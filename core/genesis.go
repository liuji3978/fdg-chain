...
func SetupGenesisBlock(db fdgdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) ToBlock(db fdgdb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db fdgdb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db fdgdb.Database) *types.Block {
...
func GenesisBlockForTesting(db fdgdb.Database, addr common.Address, balance *big.Int) *types.Block {
...
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		...
		Nonce:      66,
		GasLimit:   8000000,
		Timestamp:  1601956800,
		Difficulty: big.NewInt(8000000),
