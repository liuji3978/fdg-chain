...
func NewTable(db fdgdb.Database, prefix string) fdgdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) fdgdb.Iterator {
...
func (t *table) NewBatch() fdgdb.Batch {
...
func (b *tableBatch) Replay(w fdgdb.KeyValueWriter) error {
