...
// account array.
func checkStateAccounts(t *testing.T, db fdgdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db fdgdb.Database, root common.Hash) error {
...
func checkStateConsistency(db fdgdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(fdgdb.Database), srcRoot)
