...
type Tree struct {
	diskdb fdgdb.KeyValueStore      // Persistent database to store the snapshot
...
// background thread.
func New(diskdb fdgdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool) *Tree {
