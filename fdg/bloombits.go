...
type BloomIndexer struct {
	...
	db      fdgdb.Database       // database instance to write index data and metadata into
...
func NewBloomIndexer(db fdgdb.Database, size, confirms uint64) *core.ChainIndexer {
