...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*fdgapi.SignTransactionResult, error)
...
type UIClientAPI interface {
	...
	OnApprovedTx(tx fdgapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*fdgapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := fdgapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
